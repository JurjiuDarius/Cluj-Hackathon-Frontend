...
export class PetDetailComponent implements OnInit {
    ...
    this.tabItems = [
      {
        ...
        command: () => {
          this.router.navigate([`/details/${this.routeId}/general-information`]);
        },
      ...
      },
      {
        ...
        command: () => {
          this.router.navigate([`/details/${this.routeId}/medical-information`]);
        },
        routerLinkActiveOptions: 'active',
  ...
  private detectTabChange(): void {
    this.tabMenuService.orderTabChange$.pipe(takeUntil(this.destroy$)).subscribe({
